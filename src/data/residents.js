/* Residents for the interactive neighborhood.
   All houses share ONE resident per playthrough; the resident cycles
   John -> Samantha -> Kevin (no loop) each time the deck is opened.
   Clicking a house shows BACKGROUND only — no dialogue. */
...
/* parametric SVG portrait -> markup string */
...
export const RESIDENTS = [
  {
    ...
    portrait: { id: "john", skin: "#c9905f", hair: "#6b6359", hairStyle: "receding", facial: "stubble", cloth: "#3E5C1C", mouth: "frown", brow: true, bgA: "#cfe0ad", bgB: "#7b9a4e" },
  },
  {
    id: "samantha",
    name: "Samantha",
    ...
    portrait: { id: "samantha", skin: "#e0b083", hair: "#3a2a1c", hairStyle: "ponytail", earrings: true, cloth: "#7a3c5a", mouth: "worried", bgA: "#e7c0d0", bgB: "#a85f7e" },
  },
  {
    id: "kevin",
    name: "Kevin",
    ...
    portrait: { id: "kevin", skin: "#cf9a6e", hair: "#241a12", hairStyle: "short", glasses: true, glassColor: "#2a2a2a", tie: true, tieColor: "#1F23D6", cloth: "#cfd2c3", mouth: "flat", bgA: "#cdd8e8", bgB: "#5b6b86" },
  },
];

/* Roof positions (% of the 1152x840 aerial photo). Detected with a computer-
   vision pass (OpenCV color/shape masking in scripts/detect_roofs.py) and then
   visually validated against an overlay so every glowing dot lands on a roof. */
export const HOUSES = [
  { x: 7, y: 18 }, { x: 21, y: 23 }, { x: 47, y: 20 }, { x: 62, y: 23 },
  { x: 75, y: 38 }, { x: 16, y: 42 }, { x: 43, y: 50 }, { x: 40, y: 74 },
  { x: 70, y: 60 }, { x: 32, y: 90 }, { x: 66, y: 87 }, { x: 6, y: 89 },
];
